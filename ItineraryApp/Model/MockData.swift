...
class MockData {
    ...
    static func createmockDayModelData() -> [DayModel] {
        ...
        dayModels.append(DayModel(title: Date(), subtitle: "Exploring", data: createMockActivityModelData(sectionTitle: "April 19")))
        dayModels.append(DayModel(title: Date(), subtitle: "Scuba Diving!", data: createMockActivityModelData(sectionTitle: "April 20")))
        dayModels.append(DayModel(title: Date(), subtitle: "Volunteering", data: createMockActivityModelData(sectionTitle: "April 21")))
        dayModels.append(DayModel(title: Date(), subtitle: "Time to go back home", data: createMockActivityModelData(sectionTitle: "April 22")))
